...
class BusinessPage extends Page
{
     ...
     * Standard SS static
     **/
    public static $icon = "business_directory/images/treeicons/BusinessPage";
     ...
     **/
    public static $need_permission = array(
        'ADMIN',
     ...
     * Standard SS static
     **/
    public static $allowed_children = array("ProductPage");

    /**
     * Standard SS static
     **/
    public static $default_child = "ProductPage";

    /**
     * CODE of the group that business page admins are put in.
     **/
    protected static $member_group_code = "listing-member";
    public static function get_member_group_code()
    {
        return self::$member_group_code;
    }
    public static function set_member_group_code($s)
    {
        self::$member_group_code = $s;
    }
    /**
     * NAME of the group that business page admins are put in.
     **/
    public static $member_group_title = "Business Members";
    public static function get_member_group_title()
    {
        return self::$member_group_title;
    }
    public static function set_member_group_title($s)
    {
        self::$member_group_title = $s;
    }

    /**
     * Permission code
     **/
    public static $access_code = "ACCESS_BUSINESS";
    ...
    public static function get_can_be_child_off()
    {
        return self::$can_be_child_of;
    }
    public static function set_can_be_child_off($a)
    {
        self::$can_be_child_of = $a;
    }
    public static function add_can_be_child_off($s)
    {
        self::$can_be_child_of[] = $s;
    }
    ...
    public function CanNotEdit($member = null)
    {
    ...
    protected function getAncestorObject($type, $obj = null)
    {
        ...
        if ($parent) {
            if ($parent->ClassName == $type) {
                return $parent;
            } elseif ($child->ID != 0 && $child->exists()) {
     ...
     * @return String
     **/
    public function getDescriptiveEmail()
    {
        if ($this->ListingEmail) {
            $array = explode("@", $this->ListingEmail);
...
class BusinessPage_Controller extends Page_Controller
{
     ...
     **/
    public function savedata($data = null, $form = null)
    {
        $businessPage = DataObject::get_by_id("BusinessPage", $this->ID);
        $form->saveInto($businessPage);
        $businessPage->writeToStage('Stage');
        $businessPage->publish('Stage', 'Live');
    ...
    public function HasContacDetails()
    {
        if (
            $this->Phone
            || $this->Fax
