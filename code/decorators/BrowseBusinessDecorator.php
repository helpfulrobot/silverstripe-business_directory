...
class BrowseBusinessDecorator extends SiteTreeDecorator
{
    ...
    public static function set_classes_that_can_have_businesses_as_children($a)
    {
        self::$classes_that_can_have_businesses_as_children = $a;
    }
    public static function get_classes_that_can_have_businesses_as_children()
    {
        return self::$classes_that_can_have_businesses_as_children;
    }
...
class BrowseBusinessDecorator_Controller extends Extension
{
    ...
    public function filterforproductcategory()
    {
    }
